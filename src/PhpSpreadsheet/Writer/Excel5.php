...
class Excel5 extends BaseWriter implements IWriter
{
    ...
    public function save($pFilename = null)
    {
        ...
        $OLE = new \PhpOffice\PhpExcel\Shared\OLE\PPS\File(\PhpOffice\PhpExcel\Shared\OLE::ascToUcs($workbookStreamName));
        ...
        if (isset($this->documentSummaryInformation) && !empty($this->documentSummaryInformation)) {
            $OLE_DocumentSummaryInformation = new \PhpOffice\PhpExcel\Shared\OLE\PPS\File(\PhpOffice\PhpExcel\Shared\OLE::ascToUcs(chr(5) . 'DocumentSummaryInformation'));
        ...
        if (isset($this->summaryInformation) && !empty($this->summaryInformation)) {
            $OLE_SummaryInformation = new \PhpOffice\PhpExcel\Shared\OLE\PPS\File(\PhpOffice\PhpExcel\Shared\OLE::ascToUcs(chr(5) . 'SummaryInformation'));
    ...
    private function writeSummaryInformation()
    {
        ...
        if ($this->phpExcel->getProperties()->getCreated()) {
            ...
            $dataSection[] = array('summary'=> array('pack' => 'V', 'data' => 0x0C),
                                   ...
                                   'data'    => array('data' => \PhpOffice\PhpExcel\Shared\OLE::localDateToOLE($dataProp)));
            $dataSection_NumProps++;
        }
        //    Modified Date/Time
